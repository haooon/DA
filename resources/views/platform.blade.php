<script src="/js/echarts.min.js"></script>
    ...
    <div class="ui main text container">
        <div class="ui sizer vertical segment">
          ...
          <h2 class="ui big center aligned header smallheader">微信</h2>
          <h2 class="ui big center aligned header smallheader">微博</h2>
          <h2 class="ui big center aligned header smallheader">贴吧</h2>
          ...
          <script src="/js/plateform_choise.js" charset="utf-8"></script>
        </div>
    </div>
    @include('import')
